              ...
              <div class="auth-form-light text-left p-5">
                ...
                @endif 
                  ...
                  <div class="form-group mb-3">
                    <input type="text" name="referral_code"  class="form-control form-control-lg bg-gradient-success text-dark" id="referral_code" value="{{ $referral }}" style="pointer-events: none;">
                  </div>
                  @error('referral_code')
